# Mastermind Game
# 12 Turns to guess secret code
# User decided if they want to go first or second
# User inputs their code, computer guesses
# Computer randomly generates code, user guesses
# Code is guessed each turn and clues are given on the guess
