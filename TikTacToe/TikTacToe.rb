# Build TikTacToe Game
# Nested Array w Xs and Os and Blank Spaces
# check board each turn 
# If 3 Xs or Os in a row, win, else tie
# put board after each turn
# Objects: Game, Player, Board, Xs/Os, Results, Score
...
class Game
  ...
  def player_choice(player, symbol)
    puts "#{player} please enter your coordinates (0..2) sperated by a space"
    input = gets.chomp
  ...
  def play_game
    ...
    declare_results(@@winner)
  end
end

puts 'Welcome to tic-tac-toe. The rules are simple, but choosing placement requires reading.'
puts 'Each turn, enter two numbers with a spcae, per the grid layout below:'
puts "\r\n"
puts '0 0 | 0 1 | 0 2'
puts '1 0 | 1 1 | 1 2'
puts '2 0 | 2 1 | 2 2'
